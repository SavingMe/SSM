...
<form action="http://localhost:8080/userController/updUser" method="get">
    <c:forEach items="${list }" var="list">
        <table>
            ...
            <tr>
                <Td>
                    地址：<input type="text" name="uAddress" value="${list.uAddress }"/>
                </Td>
            </tr>

            <tr>
                <Td>
                    电话：<input type="text" name="uTel" value="${list.uTel }"/>
                </Td>
            </tr>
